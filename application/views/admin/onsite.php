    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLabel">Keterangan Produk ( <font color="Blue"><?= $Id_item ?></font> )
          </h3>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12 col-lg-6">
              ...
              <!-- Card -->
              <?php echo form_open_multipart('admin/ds/onsite/penjualanOnsite') ?>
              <input type="hidden" name="id" value="<?= $Id_item ?>">

              <div class="form-row">
                <div class="col-12 col-md-6 mb-3">
                  <label>Nama Produk</label>
                  <input type="text" class="form-control is-valid" name="input_nama" value="<?php echo $nama_item ?>" readonly="">
                </div>
                <div class="col-12 col-md-6 mb-3">
                  <label>Kategori</label>
                  <input type="text" class="form-control is-valid" name="input_kategori" value="<?php echo $kategori_item ?>" readonly>
                </div>
              </div>
              <div class="form-row">
                <div class="col-12 col-md-6 mb-3">
                ...
                <div class="col-12 col-md-6 mb-3">
                  ...
                  <input type="text" name="input_harga" class="form-control is-valid" id="harga" value="<?php echo $harga_item ?>" readonly>
                </div>
              </div>
              <div class="form-row">
                <div class="col-12 col-md-3 mb-3">
                  <img src="<?php echo base_url(); ?>timthumb.php?src=<?php echo base_url()?>uploads/<?php echo $gambar; ?>&w=170&h=150" class="img-responsive" alt="">
                </div>
              </div>
            ...
            <div class="col-12 col-lg-6 perhitungan">
              ...
              <input type="number" class="form-control" name="input_jumlahpesan" id="jumlah" placeholder="Jumlah pesanan" required>
            </div>
            <div class="col-12 col-md-6 mb-3">
              <label>Total</label>
              <input type="text" id="total" class="form-control" name="input_totalpembeli" readonly="" placeholder="Rupiah">
          </div>
        </div>
              <div class="form-row">
                <div class="col-12 col-md-6 mb-3">
              <label>Nama Pembeli</label>
              <input type="text" class="form-control" name="input_namapembeli" placeholder="Nama pembeli" required>
            </div>
            <div class="col-12 col-md-6 mb-3">
              <label>No Telp.</label>
              <input type="number" class="form-control" name="input_nomorpembeli" placeholder="No Tlp. pembeli" required>
            </div>
          </div>

              <label>Alamat Pembeli</label>
              <textarea class="form-control" name="input_alamatpembeli" data-toggle="autosize" rows="2" placeholder="Masukan alamat pembeli"></textarea>

              <label for="total">Bayar</label>
                <input type="text" class="form-control" id="bayar" name="input_bayarpembeli" placeholder="Total bayar" required>

              <label for="total">Kembalian</label>
                <input type="text" class="form-control" id="kembalian" name="input_kembalianpembeli" placeholder="Total Kembalian" readonly="">
            </div>
          </div>
        </div>
